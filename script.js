...
const ruleCoreNote = {
  eyebrow: "입문 핵심",
  title: "완성만으로는 부족합니다",
  body: "리치마작에서는 손패 모양을 완성해도 최소 1개의 역이 있어야 화료할 수 있습니다. 역은 ‘이런 모양이나 조건이면 날 수 있다’는 허가증이고, 도라는 점수를 올려주는 보너스입니다.",
};
...
const ruleUnits = [
  ...
  },
  {
    ...
    title: "한 판의 흐름",
    short: "뽑기·몸통·화료까지",
    intro: "처음에는 ‘뽑기 → 버리기 → 몸통 만들기 → 화료 확인’ 순서만 잡으면 됩니다. 치·퐁·론·쯔모 같은 말은 아래 카드에서 하나씩 이어서 봅니다.",
  },
  {
    id: "core",
    step: "3단원",
...
const scoreGuides = [
  {
    ...
    body: "처음에는 계산기가 보여주는 최종 점수를 먼저 보면 됩니다. 익숙해지면 자 론은 기본점 ×4, 친 론은 ×6처럼 친과 자에 따라 배수가 달라진다고 이해하면 됩니다.",
    chips: ["자 론 ×4", "친 론 ×6", "쯔모 분담"],
  },
  {
    eyebrow: "본장 · 만관",
    title: "본장과 고정 점수",
    body: "본장은 연속된 판을 표시하는 추가점입니다. 1본장마다 화료 점수에 300점이 더해지고, 일정 이상 높은 손은 만관처럼 정해진 점수표로 넘어갑니다.",
...
const yakuCategories = [
  {
    ...
    short: "완성만으로는 화료 불가",
    intro:
      "리치마작에서는 손패 모양을 완성하는 것만으로는 화료할 수 없습니다. 최소 1개의 역이 있어야 론이나 쯔모로 화료할 수 있습니다. 처음에는 모든 역을 외우기보다 ‘멘젠인지, 후로했는지, 어떤 모양이 보이는지’를 차례로 확인하면 됩니다.",
    kind: "intro",
    chips: ["역 1개 이상 필요", "도라만으로는 불가", "멘젠/후로 확인", "모양 단서 찾기"],
  },
  {
    step: "입문",
    title: "대기란?",
